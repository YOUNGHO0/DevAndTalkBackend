...
public class CommentController {
    ...
    @PostMapping
    public ResponseEntity creatComment(@Valid @RequestBody CommentCreateRequestDto dto, @AuthenticationPrincipal CommunityUserView user){
    ...
    @PostMapping("/child")
    public ResponseEntity createChildComment(@Valid @RequestBody ChildCommentCreateRequestDto dto, @AuthenticationPrincipal CommunityUserView user){
    ...
    @GetMapping
    public ResponseEntity getComments(@Valid @RequestBody CommentReadRequestDto dto){
    ...
    @PatchMapping
    public ResponseEntity updateComment(@Valid @RequestBody CommentUpdateRequestDto dto, @AuthenticationPrincipal CommunityUserView user){
        commentService.updateComment(dto.getCommentId(),dto.getContent(),user);
        return ResponseEntity.ok().build();
    }
    @DeleteMapping
    public ResponseEntity deleteComment(@Valid @RequestBody CommentDeleteRequestDto dto, @AuthenticationPrincipal CommunityUserView user){
